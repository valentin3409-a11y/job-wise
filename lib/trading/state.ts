...
export const DEFAULT_CONFIG: BotConfig = {
  ...
  assets: [
    // ── Core Crypto (always analyzed) ────────────────────────────────────────
    { symbol: 'BTC',   assetType: 'crypto', enabled: true },
    { symbol: 'ETH',   assetType: 'crypto', enabled: true },
    { symbol: 'SOL',   assetType: 'crypto', enabled: true },
    { symbol: 'BNB',   assetType: 'crypto', enabled: true },
    { symbol: 'XRP',   assetType: 'crypto', enabled: true },
    // ── Mid-cap Crypto ────────────────────────────────────────────────────────
    { symbol: 'ADA',   assetType: 'crypto', enabled: true },
    { symbol: 'AVAX',  assetType: 'crypto', enabled: true },
    { symbol: 'DOGE',  assetType: 'crypto', enabled: true },
    { symbol: 'LINK',  assetType: 'crypto', enabled: true },
    { symbol: 'DOT',   assetType: 'crypto', enabled: true },
    { symbol: 'MATIC', assetType: 'crypto', enabled: true },
    { symbol: 'UNI',   assetType: 'crypto', enabled: true },
    { symbol: 'ATOM',  assetType: 'crypto', enabled: true },
    { symbol: 'LTC',   assetType: 'crypto', enabled: true },
    { symbol: 'NEAR',  assetType: 'crypto', enabled: true },
    { symbol: 'ARB',   assetType: 'crypto', enabled: true },
    { symbol: 'OP',    assetType: 'crypto', enabled: true },
    { symbol: 'INJ',   assetType: 'crypto', enabled: true },
    { symbol: 'SUI',   assetType: 'crypto', enabled: true },
    { symbol: 'APT',   assetType: 'crypto', enabled: true },
    { symbol: 'TIA',   assetType: 'crypto', enabled: true },
    { symbol: 'JUP',   assetType: 'crypto', enabled: true },
    { symbol: 'WIF',   assetType: 'crypto', enabled: true },
    { symbol: 'PEPE',  assetType: 'crypto', enabled: true },
    { symbol: 'BONK',  assetType: 'crypto', enabled: true },
    // ── Core Stocks (always analyzed) ────────────────────────────────────────
    { symbol: 'AAPL',  assetType: 'stock',  enabled: true },
    { symbol: 'NVDA',  assetType: 'stock',  enabled: true },
    { symbol: 'TSLA',  assetType: 'stock',  enabled: true },
    { symbol: 'MSFT',  assetType: 'stock',  enabled: true },
    { symbol: 'GOOGL', assetType: 'stock',  enabled: true },
    { symbol: 'META',  assetType: 'stock',  enabled: true },
    { symbol: 'AMZN',  assetType: 'stock',  enabled: true },
    { symbol: 'AMD',   assetType: 'stock',  enabled: true },
    { symbol: 'COIN',  assetType: 'stock',  enabled: true },
    { symbol: 'PLTR',  assetType: 'stock',  enabled: true },
    // ── High-volatility / momentum stocks ────────────────────────────────────
    { symbol: 'MSTR',  assetType: 'stock',  enabled: true },
    { symbol: 'SMCI',  assetType: 'stock',  enabled: true },
    { symbol: 'ARM',   assetType: 'stock',  enabled: true },
    { symbol: 'NFLX',  assetType: 'stock',  enabled: true },
    { symbol: 'SHOP',  assetType: 'stock',  enabled: true },
    { symbol: 'HOOD',  assetType: 'stock',  enabled: true },
    { symbol: 'MARA',  assetType: 'stock',  enabled: true },
    { symbol: 'RIOT',  assetType: 'stock',  enabled: true },
    { symbol: 'CLSK',  assetType: 'stock',  enabled: true },
    { symbol: 'CRWD',  assetType: 'stock',  enabled: true },
  ],
  risk:      DEFAULT_RISK,
  exchanges: {
